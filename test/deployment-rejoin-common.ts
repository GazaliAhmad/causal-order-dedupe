...
Examples:
  npm run test:runtime-rejoin -- --duration 8h --dark-nodes edge-b,edge-f,edge-j
  npm run test:runtime-rejoin -- --duration 8h --recovery-window 8m --recovery-rate-per-second 3 --recovery-burst-size 18`;
}
